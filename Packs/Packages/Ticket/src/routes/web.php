...
Route::group(['namespace' => 'packs\ticket\http\controller'], function()
{
    ...
    //user page and role
    Route::get( config("ticket_config.view.user.single_ticket")??"ticket/{ticket}", 'TicketControllerUser@single_ticket')->name(config("ticket_config.view.name.single_ticket"));
